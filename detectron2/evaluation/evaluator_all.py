...
def inference_on_dataset(
    ...
    with ExitStack() as stack:
        ...
        pred_csv = pd.read_csv("/home/ll610/Onepiece/code_cs138/github/mmdetection/conic/dataset/conic/counts_pred.csv")
        true_csv = pd.read_csv("/home/ll610/Onepiece/code_cs138/github/mmdetection/conic/dataset/conic/counts_valid.csv")
        all_metrics = {}
        ...
        if segment_flag:
            np.save(f'/home/ll610/Onepiece/code_cs138/github/mmdetection/conic/dataset/conic/valid_pred.npy', segmentation_results)
            ...
            pred_array = np.load("/home/ll610/Onepiece/code_cs138/github/mmdetection/conic/dataset/conic/valid_pred.npy")
            true_array = np.load("/home/ll610/Onepiece/code_cs138/github/mmdetection/conic/dataset/conic/valid_true.npy")
